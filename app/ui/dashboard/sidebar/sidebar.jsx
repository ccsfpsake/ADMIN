...
const Sidebar = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  useEffect(() => {
    ...
    const checkIdleBuses = async () => {
      try {
        ...
        snapshot.forEach((doc) => {
          ...
          if (!lastUpdate || !lat || !lng) return;

          const idleTime = (now - lastUpdate.getTime()) / 60000; // in minutes
    ...
    const interval = setInterval(checkIdleBuses, 5000); // Check every 5 seconds
